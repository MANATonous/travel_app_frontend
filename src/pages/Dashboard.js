      ...
      <div>
        ...
        <div className="entire-dashboard">
          <div className= "header" id="dash-header">
            ...
            <button type="button" className="btn btn-lg btn-block dashboard-btn" id= "button1" onClick={this.toggleCreate}>Create New Trip</button>
            ...
            <button type="button" className="btn btn-lg btn-block dashboard-btn"  id= "button2" onClick={this.toggleJoin}>Join A Trip</button>
